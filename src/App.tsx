        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            ...
            <nav className="hidden md:flex space-x-8">
              <a href="/projetos" className="text-gray-600 hover:text-gray-900">
                Projetos
              </a>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><a href="/login?type=empresa" className="hover:text-white">Cadastrar Empresa</a></li>
                <li><a href="/projetos" className="hover:text-white">Publicar Projeto</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><a href="/login?type=freelancer" className="hover:text-white">Cadastrar-se</a></li>
                <li><a href="/projetos" className="hover:text-white">Buscar Projetos</a></li>
                <li><a href="/como-funciona" className="hover:text-white">Dicas de Sucesso</a></li>
              </ul>
            </div>
